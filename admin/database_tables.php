...
<?php
  if ( isset($action) ) {
    echo '<div class="text-right">' . tep_draw_button(IMAGE_BACK, 'fa fa-chevron-left', tep_href_link('database_tables.php')) . '</div>';
 }
?>
	...
	<div class="col-xs-12 col-sm-5 col-sm-offset-7">
		<div class="row">
			...
			<div class="col-xs-4 col-sm-4">
				<?php echo tep_draw_button(BUTTON_ACTION_GO, 'fa fa-hand-o-right', null, 'primary', null, 'btn-default'); ?>
			</div>	
		</div>
	</div>
</div>
