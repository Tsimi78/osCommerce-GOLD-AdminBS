  ...
  class d_security_checks {
    ...
    function getOutput() {
      ...
      if (isset($secCheck_messages['error'])) {
        $output .= '<div class="alert alert-danger break"><h4>Error!</h4>';
      ...
      if (isset($secCheck_messages['warning'])) {
        $output .= '<div class="alert alert-warning break"><h4>Warning!</h4>';
      ...
      if (isset($secCheck_messages['info'])) {
        $output .= '<div class="alert alert-info break"><h4>Info!</h4>';
      ...
      if (empty($secCheck_messages)) {
        $output .= '<div class="alert alert-success break"><h4>Success!</h4><p>' . MODULE_ADMIN_DASHBOARD_SECURITY_CHECKS_SUCCESS . '</p></div>';
      }
