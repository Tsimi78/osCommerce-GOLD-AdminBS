...
// calculate number of pages needing links
      ...
      if ($num_pages > 1) {
        ...
        if ($current_page_number > 1) {
		  $display_links .= tep_draw_button('', 'fa fa-chevron-left', tep_href_link($PHP_SELF, $parameters . $page_name . '=' . ($current_page_number - 1)), 'primary', null);
        } else {
		  $display_links .= tep_draw_button('', 'fa fa-chevron-left', null, 'primary', null, 'btn-default disabled');
        }
         ...
         if (($current_page_number < $num_pages) && ($num_pages != 1)) {
		   $display_links .= tep_draw_button('', 'fa fa-chevron-right', tep_href_link($PHP_SELF, $parameters . $page_name . '=' . ($current_page_number + 1)), 'primary', null);
        } else {
           $display_links .= tep_draw_button('', 'fa fa-chevron-right', null, 'primary', null, 'btn-default disabled');
        }
