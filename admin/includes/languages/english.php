...
//CUSTOM BS TEXT
define('HEADER_ACCOUNT_LOGOFF', 'Log Off');
define('ENTRY_USERNAME', 'Username');
define('ENTRY_PASSWORD', 'Password');
define('HEADER_TITLE_OSC_SITE', 'Official osC Site');
define('HEADER_TITLE_FORUM', 'osC Forum');
define('HEADER_TITLE_ADDONS', 'osC Add-ons');
define('ADMIN_LOGINS_TITLE', 'Administrator Logins');
define('TEXT_ADMIN_LOGINS', 'Last Administrator');
define('ADDONS_TITLE', 'Latest Add-ons');
define('ADDONS_TEXT', 'Add-ons');
define('ORDERS_TITLE', 'Orders');
define('CUSTOMERS_TITLE', 'Customers');
define('LATEST_NEWS_TITLE', 'Latest News');
define('LATEST_NEWS_TEXT', 'Topic');
define('REVIEWS_TITLE', 'Reviews');
define('DASHBOARD_REVIEWS_TEXT', 'Product');
...
define('IMAGE_DELETE_ALL', 'Delete All');
// Currency Update Button
define('CURRENCY_LOADING', '<i class="fa fa-refresh fa-spin"></i>Updating...');
// bootstrap helper
define('MODULE_CONTENT_BOOTSTRAP_ROW_DESCRIPTION', '<p class="alert alert-warning mt10">Content Width can be 12 or less per column per row.<br /><br />12/12 = 100% width, 6/12 = 50% width, 4/12 = 33% width.<br /><br />Total of all columns in any one row must equal 12 (eg:  3 boxes of 4 columns each, 1 box of 12 columns and so on).</p>');
// navbar menu icons
