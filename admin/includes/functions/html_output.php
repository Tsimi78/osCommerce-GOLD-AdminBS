...
// Output a form input field
  function tep_draw_input_field($name, $value = '', $parameters = '', $required = false, $type = 'text', $reinsert_value = true, $class = 'class="form-control"') {
...
// Output a form filefield
  function tep_draw_file_field($name, $required = false) {
    $field = ' <input name="' . tep_output_string($name) . '" type="file" class="filestyle" data-buttonBefore="true">';
...
// review stars
  function tep_draw_stars($rating = 0) {
    $stars = str_repeat('<span class="fa fa-star fa-lg icon-yellow"></span>', (int)$rating);
    $stars .= str_repeat('<span class="fa fa-star-o fa-lg icon-yellow"></span>', 5-(int)$rating);
