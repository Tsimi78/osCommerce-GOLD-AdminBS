...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Admin Side Menu', 'DISPLAY_SIDE_MENU', 'false', 'Display Admin Side Menu', '1', '22', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
